  ...
  return (
    <PostLayout meta={post}>
      ...
      <div className="pl-6 pr-6">
        <img
          className="w-full"
          src="/images/decentralized-finance-new-paradigms-on-how-we-business/Chart.png"
      ...
      <div className="pl-6 pr-6 mb-16">
        <img
          className="w-full"
          src="/images/decentralized-finance-new-paradigms-on-how-we-business/tweet-1.png"
